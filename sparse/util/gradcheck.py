...
class GradChecker(unittest.TestCase):
    ...
    @staticmethod
    def _func_net(x_init, sparse_net):
        """function wrapper for a net."""
        vec_to_blobs(x_init, sparse_net.params())
        return sparse_net.forward_backward()

    @staticmethod
    def _grad_net(x_init, sparse_net):
        """gradient wrapper for a net."""
        vec_to_blobs(x_init, sparse_net.params())
        sparse_net.forward_backward()
        return blobs_diff_to_vec(sparse_net.params())
    ...
    def check_network(self, sparse_net):
        """Checks a whole sparse network. Your network should not contain any
        ...
        sparse_net.forward_backward()
        param_backup = blobs_to_vec(sparse_net.params())
