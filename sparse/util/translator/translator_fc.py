"""translator_fc translates a fully connected layer to a sparse
InnerProductLayer.
"""
from sparse.util.translator import registerer
...
def translator_fc(cuda_layer, output_shapes):
    ...
    sparse_layer = core_layers.InnerProductLayer(
        name=cuda_layer['name'],
        num_output=num_output)
    # put the parameters
    params = sparse_layer.param()
    # weight
